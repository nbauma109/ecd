...
public final class DecompilerSourceLookupBridge {
    ...
    private static void installOnLaunch(ILaunch launch) {
        ...
        if ((locator == null) || (locator instanceof DecompilerSourceLookupDirector)) {
            return;
        }

        if (locator instanceof ISourceLookupDirector sourceLookupDirector) {
            launch.setSourceLocator(new DecompilerSourceLookupDirector(sourceLookupDirector));
        }
    }
}

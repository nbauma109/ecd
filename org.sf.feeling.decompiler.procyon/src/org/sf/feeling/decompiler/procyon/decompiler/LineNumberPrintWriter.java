...
/**
 * A specialization of {@link PrintWriter} which can automatically prefix lines
 * with a Java-commented, justified line number. This class overrides only the
 * {@link #print(String)} and {@link #println(String)} methods, therefore all

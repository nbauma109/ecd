...
public class SearchPatternInternalTest {
    ...
    public void searchPatternEqualsIsReflexiveNullSafeAndFieldBased() {
        ...
        SearchPattern sp1 = new SearchPattern("run", "pkg.Task.run", "pkg.Task", "(I)V", "void", pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
        SearchPattern sp2 = new SearchPattern("run", "pkg.Task.run", "pkg.Task", "(I)V", "void", pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
        // sp3 differs in name
        SearchPattern sp3 = new SearchPattern("stop", "pkg.Task.stop", "pkg.Task", "()V", null, pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    public void searchPatternHashCodeIsConsistentWithEquals() {
        ...
        SearchPattern sp1 = new SearchPattern("go", "a.B.go", "a.B", "()V", null, pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        SearchPattern sp2 = new SearchPattern("go", "a.B.go", "a.B", "()V", null, pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    public void searchPatternToStringContainsAllFieldNames() {
        ...
        SearchPattern sp = new SearchPattern("doIt", "x.Y.doIt", "x.Y", "(I)V", "void", pp, mp); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
